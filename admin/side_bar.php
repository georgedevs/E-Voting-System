<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom:0;padding-top:20px; background-color:#780A14;">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="display_votes_by_gender.php"><i class="fa fa-download fa-fw"></i> Election Analysis</a>
                        </li>         
                        <li>
