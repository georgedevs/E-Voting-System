    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
				...
				<button class="btn btn-success" data-toggle="modal" data-target="#myModal"style = "margin-left:20px; background-color:rgba(70, 10, 20, 1);">Add Candidate</button>
				<?php include ('add_candidate_modal.php');?>
                 <a href="candidate_excel.php"><button type="button" style = "margin-right:14px;  background-color:rgba(70, 10, 20, 1);" id ="print" class = "pull-right btn btn-info"><i class = "fa fa-print"></i>Export to Excel</button></a>
