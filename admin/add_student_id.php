				...
				<form action="" method = "post" >	
					...
					<div class="form-groupp">
						<label>Year First Registered</label>
							<input class="form-control" type ="date" name = "started" required="true"><p>
						
					</div>
				
					<button name = "add" type="submit" class="btn btn-primary" style="margin-left:0px; background-color:#460a14;">Add to Database</button>
				</form>
			</div>
            <div class="modal-footer">
                <a  href = "current_students.php"><button type="button" class="btn btn-default" data-dismiss="modal" style="color:white; background-color:#460a14;" >Back</button></a>
            </div>
